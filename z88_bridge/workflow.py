    ...
    if generate_stress and displacement is not None and displacement.status == "completed":
        if supports_automatic_stress_postprocess(project_dir):
            ...
            messages.append(
                ...
                "wrapper-generated OC/H8 projects; use Z88Arion GUI export or independent "
...
def supports_automatic_stress_postprocess(project_dir: str | Path) -> bool:
    ...
    The `z88rTOSS -SIG` path is reliable for OC/H8 projects generated by this
    ...
    if not isinstance(optimizer, dict) or str(optimizer.get("method", "")).lower() != "oc":
        return False
